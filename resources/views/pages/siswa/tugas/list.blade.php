        ...
        <div class="card border mb-4">
            ...
            <a href="#tugas{{ $item->id }}" class="d-block card-header py-3" data-toggle="collapse"
               role="button" aria-expanded="true" aria-controls="tugas{{ $item->id }}">
                ...
                <div class="text-xs font-weight-bold @if(strtotime(Carbon::now()) > strtotime($item->deadline) && strtotime($item->created_at) > strtotime($item->deadline)) text-danger @else text-dark @endif text-capitalize my-1">
